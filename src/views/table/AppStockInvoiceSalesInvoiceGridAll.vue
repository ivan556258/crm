  ...
  export default {
    ...
    methods: {
      initialize () {
        axios({
            method: "get",
            url:"http://localhost:8081/selectOverheadConsumablesData"
          })
          .then(response => {
      ...
      deleteItem (item) {
        ...
        axios({
            method: "post",
            url:"http://localhost:8081/deleteOverheadConsumablesData",
            data: {
                 _id: item._id,
      ...
      save () {
        if (this.editedIndex > -1) {
          axios({
              method: 'post',
              url: 'http://localhost:8081/updateOverheadConsumablesData',
              data: {
          ...
          axios({
              method: 'post',
              url: 'http://localhost:8081/insertOverheadConsumablesData',
              data: {
                  type: this.editedItem.type,
                  provider: this.editedItem.provider,
                  position: this.editedItem.position,
