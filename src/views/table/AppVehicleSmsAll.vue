  ...
  >
    <template v-slot:top>
      <v-toolbar flat color="white">
        <v-toolbar-title>Двигатель</v-toolbar-title>
  ...
  export default {
    ...
    data: () => ({
      ...
      headers: [
        ...
        { text: 'Водители', value: 'fat' },
        { text: 'Номер маяка', value: 'carbs' },
        { text: 'Тип', value: 'protein' },
        { text: 'Статус', value: 'action', sortable: false },
        { text: 'Время отпрвки', value: 'action', sortable: false },
    ...
    computed: {
      formDriveTitle () {
        return this.editedIndex === -1 ? 'Добавить двигатель' : 'Редактировать двигатель'
      },
    },
    watch: {
      dialog (val) {
