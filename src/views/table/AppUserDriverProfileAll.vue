  ...
  export default {
    ...
    data: () => ({
      ...
      headers: [
        ...
        { text: 'Телефон', value: 'fat' },
        { text: 'Серия и номер', value: 'carbs' },
        { text: 'Дата рождения', value: 'protein' },
        { text: 'Номер ВУ', value: 'action', sortable: false },
    ...
    computed: {
      formDriveTitle () {
        return this.editedIndex === -1 ? 'Добавить клиент' : 'Редактировать клиент'
      },
    },
    watch: {
      dialog (val) {
